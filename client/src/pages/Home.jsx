  ...
  return (
    <div>
      ...
      <div className=' flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-stone-500 text-xs sm:text-sm'>
          MagicRocks.com is the  tursted place to find a home for you.
          <br/>
    ...
    <Swiper navigation>
      {offerListings && offerListings.length > 0 && offerListings.map((listing)=>(
        <SwiperSlide >
        <div key={listing._id} className='h-[550px]' style={{background:`url(${listing.imageUrls[0]}) center no-repeat`
