      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
           ...
           <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
              <input type='number' id='regularPrice'  min='5000' max='800000'  className='p-3 border border-gray-300 rounded-lg '
         ...
         {formData.offer && 
         <div className='flex items-center gap-2'>
         <input type='number' id='discountPrice'  min='1000' max='80000'  className='p-3 border border-gray-300 rounded-lg '
        ...
        <div className='flex flex-col flex-1 gap-4'>
         ...
         <p className='text-red-700 text-sm'>{imageUploadError && imageUploadError}</p>
         {
          ...
          (
            ...
            <button type='button' onClick={()=>handleRemoveImage(index)} className=' p-3 text-red-500 border border-red-500 rounded  uppercase hover:shadow-lg disabled:opacity:80'>Delete</button>
            </div>
          ))
        }
         <button disabled={loading || uploading} className='p-3 bg-orange-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>
