      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
           ...
           <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
              <input type='number' id='regularPrice'  min='3000' max='10000'  className='p-3 border border-gray-300 rounded-lg 'required/>
            ...
            <div className='flex items-center gap-2'>
              <input type='number' id='discountPrice'  min='800' max='1500'  className='p-3 border border-gray-300 rounded-lg 'required/>
              <div className='flex flex-col items-center'>  
